...
export default class ListPropertiesUI extends Plugin {
    ...
    init() {
        ...
        if ((enabledProperties === null || enabledProperties === void 0 ? void 0 : enabledProperties.styles) === true || (enabledProperties === null || enabledProperties === void 0 ? void 0 : enabledProperties.styles) === false) {
            return;
        }
        if ((_b = (_a = enabledProperties === null || enabledProperties === void 0 ? void 0 : enabledProperties.styles) === null || _a === void 0 ? void 0 : _a.bulletedList) === null || _b === void 0 ? void 0 : _b.length) {
            editor.ui.componentFactory.add('bulletedList', getDropdownViewCreator({
                ...
                ].filter(item => { var _a, _b; return (_b = (_a = enabledProperties === null || enabledProperties === void 0 ? void 0 : enabledProperties.styles) === null || _a === void 0 ? void 0 : _a.bulletedList) === null || _b === void 0 ? void 0 : _b.includes(item.type); })
            }));
        }
        // Note: When this plugin does not register the "numberedList" dropdown due to properties configuration,
        // a simple button will be still registered under the same name by ListUI as a fallback. This should happen
        // in most editor configuration because the List plugin automatically requires ListUI.
        if (((_d = (_c = enabledProperties === null || enabledProperties === void 0 ? void 0 : enabledProperties.styles) === null || _c === void 0 ? void 0 : _c.numberedList) === null || _d === void 0 ? void 0 : _d.length) || enabledProperties.startIndex || enabledProperties.reversed) {
            editor.ui.componentFactory.add('numberedList', getDropdownViewCreator({
                ...
                ].filter(item => { var _a, _b; return (_b = (_a = enabledProperties === null || enabledProperties === void 0 ? void 0 : enabledProperties.styles) === null || _a === void 0 ? void 0 : _a.numberedList) === null || _b === void 0 ? void 0 : _b.includes(item.type); })
            }));
        }
    }
}
...
(_a = instance === null || instance === void 0 ? void 0 : instance.nested) === null || _a === void 0 ? void 0 : _a.length;
